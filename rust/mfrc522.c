...
static int __init mfrc522_init(void) { return mfrc522_init_rs(); }

static void __exit mfrc522_exit(void) { mfrc522_exit_rs(); }

void print(char *msg) { printk(KERN_INFO "%s", msg); }
