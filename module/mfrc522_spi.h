...
#define MFRC522_COMMAND_REG_RCV_OFF_BIT 5
#define MFRC522_COMMAND_REG_POWER_DOWN_BIT 4
...
// MFRC522 FIFOLevelReg 9.3.1.11
#define MFRC522_FIFO_LEVEL_REG 0xA
#define MFRC522_FIFO_LEVEL_REG_FLUSH_BIT 7
